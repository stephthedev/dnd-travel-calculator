...
describe('Calculate time at normal pace', function() {
  var tests = [
    //Negative tests
...
describe('Calculate time at normal pace in difficult terrain', function() {
  var tests = [
...
describe('Calculate normal pace in mixed terrain', function() {
  var tests = [
    {args: [0, 0], expected: {days: 0, hours: 0, minutes: 0}},
...
describe("Calculate time at slow pace", function() {
  var tests = [
    //Positive tests
...
describe("Calculate time at fast pace", function() {
  var tests = [
    //Positive tests
